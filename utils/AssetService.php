...
class AssetService
{
        ...
        if (!self::is_vite_running()) {
            ...
            foreach ($files as $file) {
                if (preg_match('/\.css$/', $file)) {
                    wp_enqueue_style(
                        "vite-wordpress-toolkit-plugin-css-" .
                            basename($file, ".css"),
    ...
    public static function vite_dev_server_scripts()
    {
        ...
        if (self::is_vite_running()) {
            ...
            <!-- Vite Dev Server -->
            <script type="module">
                import RefreshRuntime from "http://0.0.0.0:5173' .
                $baseURL .
                '/@react-refresh"
            ...
            echo '<script type="module" crossorigin src="http://0.0.0.0:5173' .
                $baseURL .
                '/@vite/client"></script>';
            echo '<script type="module" crossorigin src="http://0.0.0.0:5173' .
                $baseURL .
                '/src/javascript/react/main.jsx"></script>';
            echo '<script type="module" crossorigin src="http://0.0.0.0:5173' .
                $baseURL .
                '/src/javascript/vue/main.js"></script>';
    ...
    {
        $current_host =
            $_SERVER["HTTP_HOST"] ?? ($_SERVER["HTTPS_HOST"] ?? null);
    ...
    public static function enqueue_production_scripts()
    {
        ...
        foreach ($files as $file) {
            if (preg_match('/\.js$/', $file)) {
                wp_enqueue_script(
                    "vite-wordpress-toolkit-plugin-js-" .
                        basename($file, ".js"),
