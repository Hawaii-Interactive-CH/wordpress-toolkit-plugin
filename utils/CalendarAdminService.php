...
class CalendarAdminService {
	...
	public static function enqueue_scripts( $hook ) {
		...
		wp_localize_script(
			...
			[
				...
				'i18n'       => [
					'testing'         => __( 'Testing...', 'hi-theme-toolkit' ),
					'connecting'      => __( 'Connecting to Google Calendar...', 'hi-theme-toolkit' ),
					'successTitle'    => __( '✓ Connection successful!', 'hi-theme-toolkit' ),
					'calendarLabel'   => __( 'Calendar:', 'hi-theme-toolkit' ),
					'eventsFoundLabel'=> __( 'Events found:', 'hi-theme-toolkit' ),
					'unknownError'    => __( 'Unknown error', 'hi-theme-toolkit' ),
					'failureTitle'    => __( '✗ Connection failed', 'hi-theme-toolkit' ),
					'testButton'      => __( 'Test Connection', 'hi-theme-toolkit' ),
				],
			]
		);
	...
	public static function register_menu() {
		// Main menu page
		add_menu_page(
			__( 'Calendar', 'hi-theme-toolkit' ),        // Page title
			__( 'Calendar', 'hi-theme-toolkit' ),        // Menu title
		...
		add_submenu_page(
			self::MENU_SLUG,
			__( 'Google Calendar Settings', 'hi-theme-toolkit' ),
			__( 'Link Google Calendar', 'hi-theme-toolkit' ),
			'manage_options',
		...
		add_submenu_page(
			self::MENU_SLUG,
			__( 'WordPress Events Configuration', 'hi-theme-toolkit' ),
			__( 'Link WordPress Events', 'hi-theme-toolkit' ),
			'manage_options',
	...
	public static function render_main_page() {
		...
		<div class="wrap">
			<h1>
				...
				<?php esc_html_e( 'Calendar', 'hi-theme-toolkit' ); ?>
			</h1>
			...
			<div class="toolkit-calendar-dashboard">
				...
				<div class="card" style="max-width: 100%; margin-top: 20px;">
					<h2><?php esc_html_e( 'Status', 'hi-theme-toolkit' ); ?></h2>
					<table class="widefat" style="border: none;">
						<tr>
							<td style="padding: 15px;">
								<strong><?php esc_html_e( 'Google Calendar', 'hi-theme-toolkit' ); ?>:</strong>
							</td>
							<td style="padding: 15px;">
								<?php if ( $google_enabled ) : ?>
									<span style="color: #46b450; font-weight: bold;">
										✓ <?php esc_html_e( 'Enabled', 'hi-theme-toolkit' ); ?>
									</span>
								<?php else : ?>
									<span style="color: #dc3232; font-weight: bold;">
										✗ <?php esc_html_e( 'Disabled', 'hi-theme-toolkit' ); ?>
									</span>
								<?php endif; ?>
							</td>
						</tr>
						<tr style="background: #f9f9f9;">
							<td style="padding: 15px;">
								<strong><?php esc_html_e( 'WordPress Events', 'hi-theme-toolkit' ); ?>:</strong>
							</td>
							<td style="padding: 15px;">
						...
						<tr>
							<td style="padding: 15px;">
								<strong><?php esc_html_e( 'Published Events', 'hi-theme-toolkit' ); ?>:</strong>
							</td>
							<td style="padding: 15px;">
						...
						<tr style="background: #f9f9f9;">
							<td style="padding: 15px;">
								<strong><?php esc_html_e( 'Last Sync', 'hi-theme-toolkit' ); ?>:</strong>
							</td>
							<td style="padding: 15px;">
								<?php
								if ( $last_sync ) {
									...
									esc_html_e( 'Never', 'hi-theme-toolkit' );
								}
								?>
							</td>
						</tr>
				...
				<!-- Quick Actions -->
				<div class="card" style="max-width: 100%; margin-top: 20px;">
					<h2><?php esc_html_e( 'Quick Actions', 'hi-theme-toolkit' ); ?></h2>
					<p>
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=' . self::MENU_SLUG . '-wordpress-events' ) ); ?>" class="button">
							...
							<?php esc_html_e( 'Configure WordPress Events', 'hi-theme-toolkit' ); ?>
						</a>

						<a href="<?php echo esc_url( admin_url( 'admin.php?page=' . self::MENU_SLUG . '-google-calendar' ) ); ?>" class="button">
							<span class="dashicons dashicons-admin-settings" style="margin-top: 3px;"></span>
							<?php esc_html_e( 'Configure Google Calendar', 'hi-theme-toolkit' ); ?>
						</a>
						...
						<?php if ( $google_enabled || $wp_events_enabled ) : ?>
							<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display: inline;">
								...
								<button type="submit" class="button button-secondary">
									...
									<?php esc_html_e( 'Sync Now', 'hi-theme-toolkit' ); ?>
								</button>
							</form>
						<?php endif; ?>
						...
						<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=calendar_event' ) ); ?>" class="button button-primary">
							...
							<?php esc_html_e( 'View All Events', 'hi-theme-toolkit' ); ?>
						</a>
					</p>
				</div>
	...
	public static function render_settings_page() {
		...
		<div class="wrap">
			<h1>
				...
				<?php esc_html_e( 'Calendar Settings', 'hi-theme-toolkit' ); ?>
			</h1>
			...
			<form method="post" action="options.php">
				...
				<div class="card" style="max-width: 100%; margin-top: 20px;">
					<h2><?php esc_html_e( 'Google Calendar Configuration', 'hi-theme-toolkit' ); ?></h2>

					<table class="form-table" role="presentation">
						<tr>
							<th scope="row">
								<label for="google_enabled">
									<?php esc_html_e( 'Enable Google Calendar', 'hi-theme-toolkit' ); ?>
								</label>
							</th>
							<td>
								<label>
									...
									>
									<?php esc_html_e( 'Sync with Google Calendar', 'hi-theme-toolkit' ); ?>
								</label>
								<p class="description">
									<?php esc_html_e( 'Enables automatic event synchronization from Google Calendar.', 'hi-theme-toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="google_api_key">
									<?php esc_html_e( 'Google API Key', 'hi-theme-toolkit' ); ?> <span style="color: red;">*</span>
								</label>
							</th>
							<td>
								<input
								...
								>
								<p class="description">
									<?php esc_html_e( 'Your Google Calendar API key. Get a key at', 'hi-theme-toolkit' ); ?>
						...
						<tr>
							<th scope="row">
								<label for="google_calendar_id">
									<?php esc_html_e( 'Calendar ID', 'hi-theme-toolkit' ); ?> <span style="color: red;">*</span>
								</label>
							</th>
							<td>
								<input
								...
								>
								<p class="description">
									<?php esc_html_e( 'Your Google Calendar ID (e.g. your-email@gmail.com or calendar-id@group.calendar.google.com)', 'hi-theme-toolkit' ); ?>
									<br>
									<?php esc_html_e( 'Find it in Google Calendar → Settings → Integrate calendar', 'hi-theme-toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="google_max_results">
									<?php esc_html_e( 'Maximum Events', 'hi-theme-toolkit' ); ?>
								</label>
							</th>
							<td>
								<input
								...
								>
								<p class="description">
									<?php esc_html_e( 'Maximum number of events to sync (max: 2500).', 'hi-theme-toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="google_time_min_offset">
									<?php esc_html_e( 'Past Period (days)', 'hi-theme-toolkit' ); ?>
								</label>
							</th>
							<td>
								<input
								...
								>
								<p class="description">
									<?php esc_html_e( 'Number of days in the past to sync (e.g. -30 for the last 30 days).', 'hi-theme-toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="google_time_max_offset">
									<?php esc_html_e( 'Future Period (days)', 'hi-theme-toolkit' ); ?>
								</label>
							</th>
							<td>
								<input
								...
								>
								<p class="description">
									<?php esc_html_e( 'Number of days in the future to sync (e.g. 365 for the next year).', 'hi-theme-toolkit' ); ?>
								</p>
							</td>
						</tr>
					</table>
				...
				<?php submit_button( __( 'Save Settings', 'hi-theme-toolkit' ), 'primary', 'submit', true ); ?>
			</form>

			<!-- Test Connection -->
			<?php if ( $google['enabled'] && ! empty( $google['api_key'] ) && ! empty( $google['calendar_id'] ) ) : ?>
			<div class="card" style="max-width: 100%; margin-top: 20px;">
				<h2><?php esc_html_e( 'Test Connection', 'hi-theme-toolkit' ); ?></h2>
				<p>
					<?php esc_html_e( 'Verify your settings are correct by testing the connection to Google Calendar.', 'hi-theme-toolkit' ); ?>
				</p>
				<button type="button" class="button" id="test-google-connection">
					...
					<?php esc_html_e( 'Test Connection', 'hi-theme-toolkit' ); ?>
				</button>
	...
	public static function handle_sync_now() {
		...
		if ( ! isset( $_POST['toolkit_calendar_sync_nonce'] ) ||
			...
			wp_die( esc_html__( 'Security check failed.', 'hi-theme-toolkit' ) );
		}

		// Check permissions
		if ( ! current_user_can( 'manage_options' ) ) {
			wp_die( esc_html__( 'You do not have permission to perform this action.', 'hi-theme-toolkit' ) );
		}
		...
		if ( class_exists( 'Toolkit\utils\CalendarService' ) ) {
			...
			if ( ! empty( $results['google'] ) ) {
				if ( ! empty( $results['google']['success'] ) ) {
					$success_messages[] = $results['google']['message'] ?? __( 'Google Calendar synchronized', 'hi-theme-toolkit' );
				} else {
					$error_messages[] = $results['google']['message'] ?? __( 'Erreur Google Calendar', 'hi-theme-toolkit' );
				}
			}
			...
			if ( ! empty( $results['wordpress_events'] ) ) {
				if ( ! empty( $results['wordpress_events']['success'] ) ) {
					$success_messages[] = $results['wordpress_events']['message'] ?? __( 'WordPress Events synchronized', 'hi-theme-toolkit' );
				} else {
					$error_messages[] = $results['wordpress_events']['message'] ?? __( 'WordPress Events error', 'hi-theme-toolkit' );
				}
			}
			...
			if ( empty( $results ) ) {
				add_settings_error(
					'toolkit_calendar_messages',
					'toolkit_calendar_sync_error',
					__( 'No calendar source is enabled.', 'hi-theme-toolkit' ),
					'error'
				);
			}
		}
	...
	public static function render_wordpress_events_page() {
		...
		<div class="wrap">
			<h1>
				...
				<?php esc_html_e( 'Link WordPress Events', 'hi-theme-toolkit' ); ?>
			</h1>
			...
			<form method="post" action="options.php">
				...
				<div class="card" style="max-width: 100%; margin-top: 20px;">
					<h2><?php esc_html_e( 'WordPress Events Configuration', 'hi-theme-toolkit' ); ?></h2>

					<table class="form-table" role="presentation">
						<tr>
							<th scope="row">
								<label for="wordpress_events_enabled">
									<?php esc_html_e( 'Enable WordPress Events', 'hi-theme-toolkit' ); ?>
								</label>
							</th>
							<td>
								<label>
									...
									>
									<?php esc_html_e( 'Enable WordPress events management', 'hi-theme-toolkit' ); ?>
								</label>
								<p class="description">
									<?php esc_html_e( 'Enables a custom link for WordPress events.', 'hi-theme-toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="wordpress_events_custom_post_type">
									<?php esc_html_e( 'Custom Post Type', 'hi-theme-toolkit' ); ?> <span style="color: red;">*</span>
								</label>
							</th>
							<td>
								<select
									...
									class="regular-text"
								>
									<option value=""><?php esc_html_e( 'Select a Custom Post Type', 'hi-theme-toolkit' ); ?></option>
								...
								<p class="description">
									<?php esc_html_e( 'Select the Custom Post Type to use for WordPress events.', 'hi-theme-toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							<th scope="row">
								<label for="wordpress_events_acf_field_group">
									<?php esc_html_e( 'Champs ACF', 'hi-theme-toolkit' ); ?>
								</label>
							</th>
							<td>
								<?php if ( ! empty( $all_acf_fields ) ) : ?>
									...
									>
										<option value=""><?php esc_html_e( 'No ACF field selected', 'hi-theme-toolkit' ); ?></option>
									...
									<p class="description">
										<?php esc_html_e( 'Select the ACF field (including sub-fields and repeated fields) related to a date for this Custom Post Type. (Only DATE type fields are supported, works with dates inside a repeater)', 'hi-theme-toolkit' ); ?>
										<br>
										<strong><?php
											// translators: %d is the number of ACF fields available.
											printf( esc_html__( '%d fields available', 'hi-theme-toolkit' ), count( $all_acf_fields ) );
										?></strong>
									</p>
								<?php else : ?>
									<p class="description">
										<strong style="color: #dc3232;">
											<?php esc_html_e( 'ACF is not installed or no fields have been created.', 'hi-theme-toolkit' ); ?>
										</strong>
										<br>
										<?php esc_html_e( 'Install and activate Advanced Custom Fields to use this feature.', 'hi-theme-toolkit' ); ?>
									</p>
