				...
				<div class="card" style="max-width: 100%; margin-top: 20px;">
					...
					<table class="widefat" style="border: none;">
						...
						<tr style="background: #f9f9f9;">
							<td style="padding: 15px;">
								<strong><?php esc_html_e( 'Liaison Événements WordPress', 'toolkit' ); ?>:</strong>
							</td>
							<td style="padding: 15px;">
								<?php if ( $wp_events_enabled && ! empty( $wp_events_cpt ) ) : ?>
									<span style="color: #46b450; font-weight: bold;">
										✓ <?php esc_html_e( 'Activé', 'toolkit' ); ?>
									</span>
								...
								<?php else : ?>
									<span style="color: #dc3232; font-weight: bold;">
										✗ <?php esc_html_e( 'Désactivé', 'toolkit' ); ?>
									</span>
								<?php endif; ?>
							</td>
						</tr>
						<tr>
							<td style="padding: 15px;">
								<strong><?php esc_html_e( 'Événements publiés', 'toolkit' ); ?>:</strong>
							</td>
							<td style="padding: 15px;">
				...
				<div class="card" style="max-width: 100%; margin-top: 20px;">
					...
					<p>
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=' . self::MENU_SLUG . '-wordpress-events' ) ); ?>" class="button">
							...
							<?php esc_html_e( 'Configurer liaison événements WordPress', 'toolkit' ); ?>
						</a>
	...
	public static function render_wordpress_events_page() {
		...
		<div class="wrap">
			<h1>
				...
				<?php esc_html_e( 'Lier un Événements WordPress', 'toolkit' ); ?>
			</h1>
			...
			<form method="post" action="options.php">
				...
				<div class="card" style="max-width: 100%; margin-top: 20px;">
					<h2><?php esc_html_e( 'Configuration Événements WordPress', 'toolkit' ); ?></h2>

					<table class="form-table" role="presentation">
						<tr>
							<th scope="row">
								<label for="wordpress_events_enabled">
									<?php esc_html_e( 'Activer Événements WordPress', 'toolkit' ); ?>
								</label>
							</th>
							<td>
								<label>
									...
									>
									<?php esc_html_e( 'Activer la gestion des événements WordPress', 'toolkit' ); ?>
								</label>
								<p class="description">
									<?php esc_html_e( 'Active une liaison personnalisée pour les événements WordPress.', 'toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<select
									...
									class="regular-text"
								>
									<option value=""><?php esc_html_e( 'Sélectionner un Custom Post Type', 'toolkit' ); ?></option>
								...
								<p class="description">
									<?php esc_html_e( 'Sélectionnez le Custom Post Type à utiliser pour les événements WordPress.', 'toolkit' ); ?>
								</p>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<?php if ( ! empty( $all_acf_fields ) ) : ?>
									...
									>
										<option value=""><?php esc_html_e( 'Aucun champ ACF sélectionné', 'toolkit' ); ?></option>
									...
									<p class="description">
										<?php esc_html_e( 'Sélectionnez le champ ACF (incluant les sous-champs et champs répétés) relatif à une date associé à ce Custom Post Type. (ne prendra en compte que les champs de type DATE, marche si c\'est une date dans un repeater)', 'toolkit' ); ?>
										<br>
										<strong><?php printf( esc_html__( '%d champs disponibles', 'toolkit' ), count( $all_acf_fields ) ); ?></strong>
									</p>
								<?php else : ?>
									<p class="description">
										<strong style="color: #dc3232;">
											<?php esc_html_e( 'ACF n\'est pas installé ou aucun champ n\'a été créé.', 'toolkit' ); ?>
										</strong>
										<br>
										<?php esc_html_e( 'Installez et activez Advanced Custom Fields pour utiliser cette fonctionnalité.', 'toolkit' ); ?>
									</p>
