...
class DocService {
    ...
    public static function enqueue_scripts( $hook ) {
        ...
        wp_enqueue_style( 'highlightjs-default-style', WP_TOOLKIT_URL . 'admin/assets/css/highlight-default.min.css', array(), '11.11.1' );
        wp_enqueue_script( 'highlightjs', WP_TOOLKIT_URL . 'admin/assets/js/highlight.min.js', array(), '11.11.1', true );
        wp_enqueue_script( 'highlightjs-lang-go', WP_TOOLKIT_URL . 'admin/assets/js/highlight-go.min.js', array( 'highlightjs' ), '11.11.1', true );
    ...
    public static function display_markdown_docs() {
        ...
        if (
            ...
            echo '<p>' . esc_html__('File not found or access denied.', 'hi-theme-toolkit') . '</p>';
            return;
        }
        ...
        if ($requested_file !== 'index.html') {
            echo '<p><a href="' . esc_url( $index_url ) . '">' . esc_html__('Back to table of contents', 'hi-theme-toolkit') . '</a></p>';
        }
    }
    ...
    private static function render_regenerate_index_form() {
        ...
        echo '<button type="submit" class="button button-secondary">' . esc_html__('Regenerate index', 'hi-theme-toolkit') . '</button>';
        echo '</form>';
    }
