...
class ModelService
{
    ...
    public static function display_settings_page()
    {
        ...
        if (!file_exists($theme_models_path)) {
            echo "<div class='notice notice-error'><p>Models directory not found in theme. Please create a directory named 'models' in your theme's root directory and add your models there.</p></div>";
            return;
        }
