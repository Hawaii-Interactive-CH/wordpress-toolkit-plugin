...
class ModelService
{
    ...
    public static function display_settings_page()
    {
        ...
        if (empty($models)) {
            echo "<div class='notice notice-warning'><p>No models found. Please create a 'models/custom' directory in your plugin or theme and add your model files there.</p></div>";
        }
    ...
    isset($options[$model_key]) ? $options[$model_key] : 0,
); ?>>
