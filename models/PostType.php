...
abstract class PostType {
	 ...
	 *
	 * @param callable|null $callback Function that will map all post items.
	 * @return array
	 */
	 ...
	 *
	 * @param callable|null $callback The function will map all post items.
	 * @return mixed
	 */
	 ...
	 * @param callable|null $callback The function will map all results.
	 * @return array
	 */
	...
	/**
	 * Get a publication by ACF field.
	 *
	...
	/**
	 * Check if post has content after the more tag.
	 *
	 * @return bool
	 */
	...
	/**
	 * Get content after the more tag.
	 *
	 * @return string|null
	 */
	 ...
	 * @param callable|null $defaultCallback (optional) Default render if there is no thumbnail.
	 * @return mixed|null
	 */
	 ...
	 *
	 * @param callable|null $callback Callback to render a child.
	 * @return array
	 */
	...
	/**
	 * Check if post has a relation field.
	 *
	 ...
	 *
	 * @param string        $taxonomy Taxonomy class.
	 * @param callable|null $callback Optional callback.
	 * @return array
	 */
	...
	/**
	 * Map an array with an optional callback.
	 *
