...
use Toolkit\models\AbstractEvent;
...
class EventCategory extends Taxonomy
{
    ...
    {
        register_taxonomy(self::TYPE, AbstractEvent::TYPE, [
            'hierarchical' => true,
        ...
        register_taxonomy(self::SEASON, AbstractEvent::TYPE, [
            'hierarchical' => true,
            'show_admin_column' => true,
            'publicly_queryable' => false,
            'show_in_rest' => true,
        ...
        if (class_exists('Config')) {
            if (Config::acf('start_season') !== '') {
                self::newSeason(Config::acf('start_season'));
            }
            else {
                self::newSeason();
            }
