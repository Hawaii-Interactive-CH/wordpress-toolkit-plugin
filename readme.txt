...
HI Theme Toolkit gives developers a structured foundation for building robust, maintainable WordPress themes. Rather than reinventing common patterns on every project, WP Theme Toolkit provides a consistent architecture out of the box.
...
HI Theme Toolkit is designed to complement a custom theme. It will activate on any theme but most features are only useful when your theme extends the provided base models.
